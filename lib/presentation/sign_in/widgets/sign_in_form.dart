...
class SignInForm extends StatelessWidget {
  Widget emailField(BuildContext context) => Padding(
  ...
  //       ),
  //     );
  Widget passwordField(BuildContext context) => Container(
        padding: EdgeInsets.symmetric(horizontal: 7.0.w),
        child: Material(
          elevation: 5.0,
          shape:
  ...
  Widget registerLink(BuildContext context) => Padding(
  ...
  Widget socialLoginButtons() => Padding(
